...
const NOTIFICATIONS = [
  {
    ...
    tweet: {
      id: "t1",
      content: "Just had a great session working on our new project. #coding #nextjs",
    }
  },
  {
    id: "2",
  ...
  },
  {
    ...
    tweet: {
      id: "t3",
      content: "Hey @johndoe, what do you think about the new React 18 features?",
    }
  },
];
    ...
    <DefaultLayout>
      ...
      <header className="sticky top-0 bg-white bg-opacity-90 backdrop-blur-sm z-10 border-b border-gray-200">
        ...
        <div className="flex border-b border-gray-200">
          <button className="flex-1 py-3 font-bold text-blue-500 border-b-2 border-blue-500">All</button>
            ...
            <div className="flex space-x-3">
              ...
              <div>
                ...
                {notification.type === "mention" && (
                  <p>
                    <span className="font-bold">{notification.user.name}</span>
                    <span className="text-gray-500"> mentioned you in a Tweet</span>
                  </p>
                )}
                
                {notification.tweet && (
                  <p className="mt-1 text-gray-800">"{notification.tweet.content.length > 60 
                    ? notification.tweet.content.substring(0, 60) + "..."
                    : notification.tweet.content}"</p>
                )}
              </div>
            </div>
          </div>
